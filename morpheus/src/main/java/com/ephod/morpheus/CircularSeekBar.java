...
public class CircularSeekBar extends View {
    ...
    /**
     * {@code Paint} instance used to draw the album_art.
     */
    private Paint albumArtPaint;
	/**
	...
	private void initPaints() {
        albumArtPaint = new Paint();
        albumArtPaint.setAntiAlias(true);
	...
	protected void onDraw(Canvas canvas) {
        ...
        /*if(image != null){
            canvasSize = canvas.getWidth() - 25;

            BitmapShader shader = new BitmapShader(Bitmap.createScaledBitmap(image, canvasSize, canvasSize, false), Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
            albumArtPaint.setShader(shader);

            float borderWidth = mCircleStrokeWidth;
            float circleCenter = (canvasSize - (borderWidth * 2)) / 2;
            canvas.drawCircle(circleCenter + borderWidth + 12, circleCenter + borderWidth + 12, ((canvasSize - (borderWidth * 2)) / 2) - 14.0f, albumArtPaint);
        }*/
